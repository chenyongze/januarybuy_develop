...
$(function($){
	$("#ajax_loading").ajaxStart(function(){
...
</script><title><?php echo (L("website_manage")); ?></title></head><body><div id="ajax_loading">提交请求中，请稍候...</div><?php if($show_header != false): if(($sub_menu != '') OR ($big_menu != '')): ?><div class="subnav"><div class="content-menu ib-a blue line-x"><?php if(!empty($big_menu)): ?><a class="add fb" href="<?php echo ($big_menu["0"]); ?>"><em><?php echo ($big_menu["1"]); ?></em></a>　<?php endif; ?></div></div><?php endif; endif; ?><script type="text/javascript" src="__ROOT__/statics/js/jquery/plugins/jquery.imagePreview.js"></script><div class="pad-10" ><form name="searchform" action="" method="get" ><table width="100%" cellspacing="0" class="search-form"><tbody><tr><td><div class="explain-col">            	发布时间：        
				<link rel="stylesheet" type="text/css" href="__ROOT__/statics/js/calendar/calendar-blue.css"/><script type="text/javascript" src="__ROOT__/statics/js/calendar/calendar.js"></script><input class="date input-text" type="text" name="time_start" id="time_start" size="18" value="<?php echo ($time_start); ?>" /><script language="javascript" type="text/javascript">	                    Calendar.setup({
		...
		<input class="date input-text" type="text" name="time_end" id="time_end" size="18" value="<?php echo ($time_end); ?>" /><script language="javascript" type="text/javascript">	                    Calendar.setup({
	                        inputField     :    "time_end",
	                        ifFormat       :    "%Y-%m-%d",
	                        showsTime      :    "true",
	                        timeFormat     :    "24"
...
function sort(id,type,num){
    ...
    $.get("<?php echo u('items/sort');?>", { id: id, type: type,num:num }, function(jsondata){
